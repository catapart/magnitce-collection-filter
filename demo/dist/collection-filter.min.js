...
</search>`;var u=class{constructor(t,r,e){this.value=t;this.start=r;this.end=e}},l=class{constructor(t,r,e,i){this.item=t;this.queryMatches=r;this.filter=e;this.propertyName=i}},h=class{constructor(t,r="textQuery",e){this.value=t;this.type=r;this.compare=e}},p=class{filters=[];query="";utilities;constructor(){this.utilities={matchTextQuery:this.matchTextQuery,matchRegexQuery:this.matchRegexQuery}}setQuery(t,r,e=null){let i=this.filters.findIndex(n=>n.type=="textQuery"||n.type=="regexQuery");if(i!=-1&&this.removeFilter(i),t=="")return;let s=e=="regex"?"regexQuery":"textQuery";this.addFilter(t,s,r)}addFilter(t,r,e){let i=new h(t,r,e);return this.filters.push(i),i}addFilters(...t){this.filters.concat(t)}removeFilter(t){this.filters.splice(t,1)}filterItems(t,r){let e=[],i=!1;for(let s=0;s<t.length;s++){i=!1;let n=null;for(let o=0;o<this.filters.length;o++){let c=this.filters[o].compare.call(r??this,this.filters[o],t[s],this.utilities);if(c!=!1?n=c:i=!0,i==!0)break}i==!1&&n!=null&&e.push(n)}return e}matchTextQuery(t,r){let e=[],i=r.toLowerCase().indexOf(t.toLowerCase());if(i==-1)return e;let s=new u(t,i,i+t.length);return e.push(s),e}matchRegexQuery(t,r){let e=Array.from(r.matchAll(new RegExp(t,"gi"))),i=[];for(let s=0;s<e.length;s++){let n=e[s],o=n[0],c=new u(o,n.index,n.index+o.length);i.push(c)}return i}};var y=new CSSStyleSheet;y.replaceSync(d);var f="collection-filter",m=class extends HTMLElement{componentParts=new Map;getElement(t){if(this.componentParts.get(t)==null){let r=this.findElement(t);r!=null&&this.componentParts.set(t,r)}return this.componentParts.get(t)}findElement(t){return this.shadowRoot.getElementById(t)}itemFilters=new p;get filterPropertyAttribute(){return this.getAttribute("filter-property")??"data-filter-property"}constructor(){if(super(),this.closest("form")!=null)throw new Error("The <collection-filter> element cannot be placed inside of a <form> element.");this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=g,this.shadowRoot.adoptedStyleSheets.push(y),this.findElement("form").addEventListener("submit",r=>{let e=this.hasAttribute("regex")?"regex":null,i=e=="regex"?this.regexQueryComparison:this.textQueryComparison;return this.itemFilters.setQuery(this.findElement("input").value,i,e),this.dispatchEvent(new CustomEvent("change",{detail:{filters:this.itemFilters.filters}})),r.preventDefault(),r.stopPropagation(),!1}),this.findElement("regex-button").addEventListener("click",()=>{this.hasAttribute("regex")?(this.removeAttribute("regex"),this.part.remove("regex"),this.findElement("regex-button").part.remove("regex","active")):(this.toggleAttribute("regex",!0),this.part.add("regex"),this.findElement("regex-button").part.add("regex","active"))}),this.findElement("input").addEventListener("input",r=>{r.currentTarget.value==""&&(this.itemFilters.setQuery("",()=>!1),this.dispatchEvent(new CustomEvent("change",{detail:{filters:this.itemFilters.filters}})))})}static observedAttributes=["placeholder"];attributeChangedCallback(t,r,e){t=="placeholder"&&(this.findElement("input").placeholder=e)}filterElements(t){return this.itemFilters.filterItems(t,this)}textQueryComparison(t,r,e){let i=r.getAttribute(this.filterPropertyAttribute),s=i??r.textContent??"",n=e.matchTextQuery(t.value,s);return n.length==0?!1:new l(r,n,t,i==null?"[ Text Content ]":this.filterPropertyAttribute)}regexQueryComparison(t,r,e){let i=r.getAttribute(this.filterPropertyAttribute),s=i??r.textContent??"",n=e.matchRegexQuery(t.value,s);return n.length==0?!1:new l(r,n,t,i==null?"[ Text Content ]":this.filterPropertyAttribute)}connectedCallback(){this.#t()}#t(){let t=[...this.shadowRoot.querySelectorAll("[id]")];for(let e=0;e<t.length;e++)t[e].part.add(t[e].id);let r=[...this.shadowRoot.querySelectorAll("[class]")];for(let e=0;e<r.length;e++)r[e].part.add(...r[e].classList)}};customElements.get(f)==null&&customElements.define(f,m);export{m as CollectionFilterElement};
