...
var collection_filter_exports = {};
__export(collection_filter_exports, {
  CollectionFilterElement: () => CollectionFilterElement
});
module.exports = __toCommonJS(collection_filter_exports);
